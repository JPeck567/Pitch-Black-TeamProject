...
public class GameOverScreen implements Screen {
	...
	public GameOverScreen(PitchBlackGraphics x) {
		parent = x;
		...
		table.setBackground(new TextureRegionDrawable(new TextureRegion(new Texture("background/gameOverBackGround.png"))));
